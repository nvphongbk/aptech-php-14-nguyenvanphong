...
<html lang="en">
  ...
  <div class="card">
    ...
    <?php 
    $link = 'http://www.crashzone.com.au';
    $arr = [
      "id" => 4469,
...
<div class="card">
<a href="#">
<img class="card-img-top w-100" src="' . $link . $arr['images'][0]['path'] . '">
</a>;
<div class="card-body">
<a href="http://phongnguyen.vn/PHP/2018-09-11/content-card.php"<h5 class="card-title"><h5>' . $arr['title'] . '</h5><hr></a>
  <p class="card-text">' . $arr['description'] . '</p>
  <div class="card-footer px-0">
  <p class="text-muted">winston@crashzone.com.au</p>
  <div class="d-flex justify-content-between">
  <p>Post by: ' . $arr['author']['name'] . ' At: ' . $arr['updated_at'] . '</p>
 <p> <a href="http://phongnguyen.vn/PHP/2018-09-11/content-card.php" target="_blank">Read more>> </a></p>
  </div>
  </div>
